...
const LoadProfileChart: React.FC = () => {
  ...
  const loadData: LoadData[] = [
    ...
    { hour: 8, sts: 12, tt: 15, rtg: 11, shorePower: 9, reefers: 5, total: 47 },
    { hour: 9, sts: 13, tt: 16, rtg: 12, shorePower: 9, reefers: 5, total: 46 },
    { hour: 10, sts: 14, tt: 17, rtg: 13, reefers: 5, shorePower: 10, total: 45 },
    { hour: 11, sts: 15, tt: 18, rtg: 14, shorePower: 11, reefers: 5, total: 46 },
    { hour: 12, sts: 16, tt: 19, rtg: 15, shorePower: 12, reefers: 5, total: 48 },
